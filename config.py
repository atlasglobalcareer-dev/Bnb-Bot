...
class Settings:
    ...
    min_liquidity_usd: float = field(default_factory=lambda: _float("MIN_LIQUIDITY_USD", 3_000))
    min_volume_24h_usd: float = field(default_factory=lambda: _float("MIN_VOLUME_24H_USD", 5_000))
    min_score_to_alert: float = field(default_factory=lambda: _float("MIN_SCORE_TO_ALERT", 60))
    min_1h_transactions: int = field(default_factory=lambda: _int("MIN_1H_TRANSACTIONS", 8))
    ...
    min_buy_sell_ratio: float = field(default_factory=lambda: _float("MIN_BUY_SELL_RATIO", 1.05))
